            ...
            <div className="flex-initial w-full ">
                <div className="p-8 mx-10 md:mx flex items-center gap-7">
                    <div className="flex-col flex items-start m-4 w-full lg:w-2/5 ">
                        <label htmlFor="file" className="font-bold text-lg cursor-pointer"><AddPhotoAlternateIcon fontSize="large" /></label>
                        ...
                        <img className={data?.profile && "h-36 w-36 rounded-full object-cover cursor-pointer"} src={data?.profile} alt="" />
